...
<body>
	...
	<div style="padding: 5px; width: 705px; height: 557px; border: solid black 1px;">
        ...
        <h7><b>LAPORAN AKTIVITAS KELAS</b></h7><br>
		...
		<table style="border: 1px solid black;">
            ...
            @foreach ($class_running as $item)
                <tr>
                    <td style="border: 1px solid black; padding: 5px;">{{$item['class_name']}}</td>
                    <td style="border: 1px solid black; padding: 5px;">{{$item['fullname']}}</td>
                    <td style="border: 1px solid black; padding: 5px;">{{$item['total_peserta']}}</td>
